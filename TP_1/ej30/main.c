...
void procesar(){
  FILE *arText,*arBinario; // se puede hacer la lectura de archivo de texto leyendo normal y teniendo el último caracter en el último valor
  TReg reg;                // o hacer lectura adelantada pero tener una línea vacía para que pueda leer el último valor del archivo de texto
  char patente[7], fecha[17]; // (yo prefiero la primera)
